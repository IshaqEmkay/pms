...
<tr>
  <th>Post Gradute Year of Passing</th>
  <td><?php echo $row['YearPassingPG'];?></td>
</tr>
<tr>
  <th>Post Graduate Grade</th>
  <td><?php echo $row['PercentagePG'];?></td>
</tr>
<tr>
  <th>Under-Graduate Course Name</th>
  <td><?php echo $row['CourseGra'];?></td>
</tr>
<tr>
  <th>Under-Graduate School/College</th>
  <td><?php echo $row['SchoolCollegeGra'];?></td>
</tr>
<tr>
  <th>Under-Graduate Year of Passing</th>
  <td><?php echo $row['YearPassingGra'];?></td>
</tr>
<tr>
  <th>Under-Graduate Grade</th>
  <td><?php echo $row['PercentageGra'];?></td>
</tr>
<th>SSCE Course Name</th>
...
<form class="user" method="post" action="">
 <h3> Post Graduate</h3>
               <div class="row">
                ...
                <div class="col-4 mb-3">Course</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="coursepg" name="coursepg" aria-describedby="emailHelp" value=""></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">School/College</div>
