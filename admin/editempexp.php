...
<head>
  ...
  <title>Edit Employee Expirience</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit Employee Expirience</h1>
...
?>
               <div class="row">
                <div class="col-4 mb-3">First Work Place</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp1name" name="emp1name" aria-describedby="emailHelp" value="<?php  echo $row['Employer1Name'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3"> Work As </div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">Salery Per Month  </div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Work Duration</div>
                     <div class="col-8 mb-3">
                    ...
                    <div class="row">
                <div class="col-4 mb-3">Second Work Place (if any)</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="emp2name" name="emp2name" aria-describedby="emailHelp" value="<?php  echo $row['Employer2Name'];?>"></div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">Salary Per Month</div>
                    <div class="col-8 mb-3">
                    ...
                    <div class="row">
                <div class="col-4 mb-3">third Work Place (if any)</div>
...
<?php 
    ...
    echo "<center>Employee Expirience Record is Empty</center>";
