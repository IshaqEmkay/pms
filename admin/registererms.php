...
<body class="bg-gradient-primary">
  ...
  <div class="container">
    <h3 align="center" style="color: black; padding-top: 1%">Employee Registration</h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <div align="right"><a href="..\admin\applicant.php" class="btn btn-info" >Back</a></div>
    ...
    echo $msg;
              ...
              <input type="submit" name="submit" value="Creat Account" class="btn btn-primary btn-user btn-block">
