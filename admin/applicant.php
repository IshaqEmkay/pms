...
if (strlen($_SESSION['aid']==0)) {
  header('location:logout.php');
    ...
    {
        $sql ="DELETE FROM empapply WHERE id='$_GET[deltid]'";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Applicant List</h1>

<p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
  }  ?> </p>
<!-- <div class="text-center">
                    <a class="small btn btn-primary btn-lg my-3" href="registererms.php">Add Employees <i class="fa-fa-edit fa-white"></i>
                    </a>
                  </div> -->
...
<?php
$ret=mysqli_query($con,"select * from empapply");
$cnt=1;
...
echo '
<a href="registererms.php?editid='.$row['id'].'"><i class="fa fa-check"></i></a> | |
';
  }
  ?> 
   <a href="applicant.php?deltid=<?php echo $row['id'];?>"><i class="fa fa-times"></i></a>
  </td>
</tr>
