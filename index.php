      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin-top: 2%">
            <h1 class="h3 mb-0 text-gray-800">Alliance Personel Management Portal</h1>
          </div>
              ...
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <a href="empapply.php">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Apply For Job</div>
                 </a>
                    </div>
                    <div class="col-auto">
